...
class TestPerson:
    ...
    def test_helskole(self):
        ...
        prObj2 = mixer.blend('administration.Person', grade=grObj, first_name='Test',last_name='Testesen')
        scObj.save()
        grObj.save()
        prObj.createusername()
        prObj.save()
        prObj2.createusername()
        prObj2.save()"""
    ...
    def test_createUsername(self):
        modeller = mixer.cycle(3).blend('administration.Person', first_name='T', last_name='A')
        ...
        assert modeller[2].username == 'ta2', 'Should have the iterative username "ta2"'
...
class TestSchool:
    def test_init_school(self):
        obj = mixer.blend('administration.Person',first_name = 'tester', last_name='Testesen', sex='M')
        obj.createusername()
        obj.save()
        obj2 = mixer.blend('administration.Person',first_name = 'tester', last_name='Testesen', sex='M')
        obj2.createusername()
        obj2.save()
