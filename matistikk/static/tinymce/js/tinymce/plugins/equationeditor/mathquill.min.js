(function () {
    ...
    var a, o, c, h, l, u, p, f, d, m, g, b, v, w, x, j, k, q, y, Q, C, S, L, D, O, E, A, R, T, z, B, I, $, _, W, M, F,
        P, U, H, K, N, G, X, Z, Y, J, V, te, ee, ne, ie, re, se, ae = window.jQuery, oe = "mathquill-command-id",
        ce = "mathquill-block-id", he = Math.min;
    Math.max, o = [].slice, c = function (t, e, n) {
        ...
        t.init = function () {
            ...
            var e = f(t);
            return e.find("*").addBack().each(function () {
        ...
        e.init = function (t, e, n) {
            ...
            var t, e, i, r = this, s = r.blocks, a = " mathquill-command-id=" + r.id,
    ...
    D ? L = function (t, e, n) {
        ...
        var n = l.string, i = l.regex, r = l.letter, s = l.any, a = l.optWhitespace, o = l.succeed, c = l.fail,
            h = r.map(X), u = i(/^[^${}\\_^]/).map(Z),
            f = i(/^[^\\a-eg-zA-Z]/).or(n("\\").then(i(/^[a-z]+/i).or(i(/^\s+/).result(" ")).or(s))).then(function (t) {
                var e = S[t];
