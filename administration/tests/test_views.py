...
class PersonCreateViewTestCase(LiveServerTestCase):
    ...
    def test_admin_can_create_school(self):
        ...
        self.selenium.find_element_by_id('id_school_name').send_keys('TestSchooladminSchool')
        ...
        time.sleep(0.1)
        self.assertEqual(1, len(School.objects.filter(school_name='TestSchooladminSchool')))
